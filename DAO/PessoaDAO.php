...
class PessoaDAO
{
    ...
    //Retorna um registro específico da tabela pessoa no bd 
    //método exige um parâmetro $id do tipo inteiro.
    public function selectByid(int $id)
    {
       ...
       return $stmt->fetchObject("PessoaModel"); //Retornando um objeto específico de Pessoa Model
    }
